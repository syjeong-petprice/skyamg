...
동물전용 한방의료기구 사용`,
    ...
    pride: {
      title: "한방치료는 한계를 뛰어 넘는 도약이 될 수 있습니다.",
      description: `한방 침 치료는 통증 관리, 소화기 증상 완화, 만성 질환의 증상 개선 등에 탁월한 효과가 있습니다. 건침, 약침, 전침, 뜸을 사용하는 침법은 한방 치료 단독으로도 충분한 임상증상 개선을 이룰 수 있으며 양방과 병행시 효과가 배가됩니다. 
      
인천SKY동물메디컬센터에서는 동물침치료인증교육 수료 수의사들의 주관하의 양한방 병용의 효과 높은 치료를 경험해보실 수 있습니다.
      
치료의 새 방향을 제시하는 선택, 인천SKY동물메디컬센터입니다.
      `,
    },
  },
  {
