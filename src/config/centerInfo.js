...
병원급 시스템으로 즉각적인 치료 대응이 가능합니다.`,
    ...
    equip: [
      ...
      },
      {
        ...
        description:
          "MRI에 탑재된 첨단 기술로 뇌, 복부, 척추, 관절에서의 신경, 혈관, 인대의 미세한 조직까지 다양한 영역에서의 정밀 진단이 가능합니다. SKY동물메디컬센터는 독일 제너럴일렉트릭사의 프리미엄 MRI장비인 GE SIGNA Creator 1.5T를 활용하고 있습니다. 현재 동물병원에서 운용되는 장비 중 최고 사양을 갖춘 장비로 퀄리티있는 이미지뿐만 아니라 다른 장비와 비교해 최대 40%까지 검사시간 단축을 통해 환자에게서 마취 시간을 감소시킬 수 있다는 장점을 갖추고있습니다.",
      },
    ],
    // surgery: [],
    surgery: [
